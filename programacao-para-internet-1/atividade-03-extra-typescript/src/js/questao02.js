class Funcionario {
    constructor(nome, valorTotalDeVendasNoMes) {
        this._nome = nome;
    ...
    set salarioComComissao(salarioComComissao) {
    ...
    set valorTotalDeVendasNoMes(valorTotalDeVendasNoMes) {
        this._valorTotalDeVendasNoMes = valorTotalDeVendasNoMes;
    }
    ...
    mostraDadosDoFuncionario() {
        alert(`O funcionário(a) ${this.nome} vendeu no mês R$${this.valorTotalDeVendasNoMes.toFixed(2)} e então seu salário bruto é de R$${this.salarioComComissao.toFixed(2)}`);
    }
}
const $inputNomeDoFuncionario = document.querySelector("#nome-do-funcionario");
const $inputValorTotalDeVendasNoMes = document.querySelector("#valor-total-de-vendas-mes");
const $formQuestao02 = document.querySelector("#form-questao02");
$formQuestao02.addEventListener("submit", (event) => {
    ...
    const funcionario = new Funcionario(nomeDoFuncionario, valorTotalDeVendasNoMes);
